...
class JwtUtilTest {
    ...
    void validateTokenAndGetUserId_ExpiredToken() {
        ...
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId(expiredToken);
        });
    }
    ...
    void validateTokenAndGetUserId_TamperedToken() {
        ...
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId(tamperedToken);
        });
    }
    ...
    void validateTokenAndGetUserId_WrongSignature() {
        ...
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId(tokenWithDifferentSignature);
        });
    }
    ...
    void validateTokenAndGetUserId_MalformedToken() {
        ...
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId(malformedToken);
        });
    }
    ...
    void validateTokenAndGetUserId_NullToken() {
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId(null);
        });
    }
    ...
    void validateTokenAndGetUserId_EmptyToken() {
        assertThrows(JwtException.class, () -> {
            jwtUtil.validateTokenAndGetUserId("");
        });
    }
